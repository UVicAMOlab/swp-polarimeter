...
#parameters for size and duration of chunk
...
scan_rate = 10000.0 # Breaks above 100,000
...
# ax1.set_xlim([0,1000])
# ax1.set_title('Input Sine Wave: A = 1.7V, f = 1.50 kHz')
...
#write to file with data from chunk
file = open('read_result.txt','w')
file.write(str(read_result.data))
file.close()
